...
export default function ProjectOwnerAuthentication() {
  ...
  const handleLogin = () => {
    navigate(createPageUrl('Authentication'), { state: { userType: 'project_owner' } });
  };

  const handleSocialSignup = (provider) => {
    // For demo purposes, all social signups go to email signup
    handleEmailSignup();
  };

  return (
    <div className="min-h-screen bg-white flex flex-col justify-end p-4 pb-8">
