...
export default function ProjectOwnerOTPVerification() {
  ...
  const handleSuccessDone = () => {
    ...
    // Navigate directly to explainer video instead of language selection
    navigate(createPageUrl('ExplainerVideo'));
  };
