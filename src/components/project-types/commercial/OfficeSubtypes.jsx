...
export default function OfficeSubtypes({ onSelectSubtype, onBack }) {
  const subtypes = [
    { 
    ...
    { 
      value: 'multi_tenant_office', 
      label: 'Multi-tenant office buildings',
    ...
    { 
      ...
      label: 'Government office buildings',
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            What type of office building?
          </h1>
          <p className="text-gray-600">
            Select the specific type of office building for your project
          </p>
        </div>
